            ...
            <form className="col-sm-12">
                {this.state.goBack === false &&
                    <div>
                        ...
                        <button onClick={this.handleGoBackPersonForm.bind(this)} type="button" className="btn btn-primary mt-5 mr-2 float-right">Voltar</button>
                </div>
                }
